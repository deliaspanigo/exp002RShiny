...
df_decision_cases <- data.frame("Caso" = "",
...
# the_table <- fn_show_table_dynamic(object_name = "df_decision_cases", caption_text = "") %>%
...
# knitr::kable(df_decision_cases, format = "html", caption = "Resumen de Casos Posibles en ANOVA") %>%
