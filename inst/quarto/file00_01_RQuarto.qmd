...
# # # # # Section 02 - Import dataset ----------------------------------------
  #+++---my_dataset <- AAA_import_dataset_external_AAA
...
# El internal
# # # # # Section 02 - Import dataset ----------------------------------------
  #+++---my_dataset <- AAA_import_dataset_internal_AAA
  head(x = my_dataset, n = 5)
```
...
# # # # # Section 03 - Settings ----------------------------------------------
  #+++---var_name_rv     <- "BBB_var_name_rv_BBB"
  #+++---var_name_rv

  #+++---var_name_factor <- "BBB_var_name_factor_BBB"
  #+++---var_name_factor

  #+++---alpha_value     <-  BBB_alpha_value_BBB
  #+++---alpha_value

  #+++---vector_ordered_levels <- CCC_vector_ordered_levels_CCC
  #+++---vector_ordered_levels
  
  #+++---vector_ordered_colors <- CCC_vector_ordered_colors_CCC
...
objetos_reporte_word <- c("df_summary_anova")
objetos_reporte_excel <- c("df_summary_anova")

# 2. Guardar por lote específico
save(list = objetos_reporte_word, file = "output_folder/reporte_word_objetos.RData")
save(list = objetos_reporte_excel, file = "output_folder/reporte_excel_objetos.RData")
